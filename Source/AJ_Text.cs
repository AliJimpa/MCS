...
namespace AJ_Text
{
    public class Textfile
    {
        ...
        public Textfile(string newname)
        {
            // Debug FileName
            if (newname == "")
                Debug("New Textfile class have not name");
        ...
        /// <summary>
        /// Constuct class with filename & filepath, if filepath is empty save in defult base app path.
        /// </summary>
        /// <param name="newname">Set filename</param>
        /// <param name="newpath">Set filepath</param>
        public Textfile(string newname, string newpath)
        {
            // Debug FileName
            if (newname == "")
                Debug("New Textfile class have not name");
        ...
        // Debug Method for Write Message in Console
        private void Debug(string Message)
        {
            Console.WriteLine($"[AJ_Text] : {Message}");
        }
